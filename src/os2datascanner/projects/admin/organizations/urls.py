...
urlpatterns = [
  ...
  path(
    'add',
    views.AddOrganizationView.as_view(),
    name='add-organization'),
  path(
    'add_for/<uuid:client_id>',
    views.AddOrganizationView.as_view(),
  ...
  path(
    '<slug:slug>/org_delete_blocked',
    views.OrganizationDeletionBlocked.as_view(),
    name='org_delete_block'),
  path(
    '<slug:org_slug>/accounts/',
    views.AccountListView.as_view(),
    name='accounts'),
  path(
    '<slug:org_slug>/accounts/<uuid:pk>',
    views.AccountDetailView.as_view(),
    name='account'),
  path(
    '<slug:org_slug>/accounts/<uuid:acc_uuid>/alias/create',
    views.AliasCreateView.as_view(),
    name='create-alias'),
  path(
    '<slug:org_slug>/accounts/<uuid:acc_uuid>/alias/<uuid:pk>/delete',
