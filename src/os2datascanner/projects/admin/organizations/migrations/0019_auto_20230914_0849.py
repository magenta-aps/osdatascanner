# Generated by Django 3.2.11 on 2023-09-14 06:49
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            field=models.CharField(choices=[('SD', 'Single DPO'), ('UD', 'Unit DPO')], default='UD', max_length=2, verbose_name='DPO contact style'),
        ),
        migrations.AddField(
            model_name='organization',
            name='dpo_name',
        ...
        migrations.AddField(
            ...
            field=models.CharField(choices=[('WS', 'Website'), ('EM', 'Email')], default='EM', max_length=2, verbose_name='support contact style'),
        ),
        migrations.AddField(
            model_name='organization',
            name='support_name',
