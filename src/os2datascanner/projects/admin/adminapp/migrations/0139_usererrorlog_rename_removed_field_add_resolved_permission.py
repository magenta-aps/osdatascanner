# Generated by Django 3.2.11 on 2024-12-05 12:06
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('os2datascanner', '0138_alter_scanstatus_options'),
    ]

    operations = [
        migrations.AlterModelOptions(
            name='usererrorlog',
            options={'permissions': [('resolve_usererrorlog', 'Can resolve error log')], 'verbose_name': 'error log', 'verbose_name_plural': 'error logs'},
        ),
        migrations.AddField(
