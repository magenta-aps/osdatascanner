...
from ..utils import iterate_queryset_in_batches, get_max_prop_value
...
def bulk_update_probability_value(apps, schema_editor):
    ...
    for batch in iterate_queryset_in_batches(10000, queryset):
        for dr in batch:
            max_value = get_max_prop_value(dr, 'probability')
            dr.probability = max_value
        DocumentReport.objects.bulk_update(batch, ['probability'])
