...
(function (factory) {
  ...
  $(document).on('click.modal', '[data-modal~="modal:close"]', $.modal.close);
  $(document).on('click.modal', '[data-modal~="modal:open"]', function(event) {
