...
ALL_MATCHES = [
    {'match': '0101XXXXXX',
     'offset': 86,
     'context': 'der opfylder Modulus 11 tjek. Anders And 010180-0008',
     'context_offset': 50,
     'sensitivity': None,
     'probability': 1.0},
    {'match': '0202XXXXXX',
     'offset': 67,
     'context': 'der indgår cpr i linjen Anders And, cpr: [020280-0009',
     'context_offset': 50,
     'sensitivity': None,
     'probability': 1.0},
    {'match': '0303XXXXXX',
     'offset': 63,
     'context': 'rdi parenteser er balanceret Anders And, [030380-0018], Paradisæblevej 111',
     'context_offset': 50,
     'sensitivity': None,
     'probability': 1.0},
    {'match': '0404XXXXXX',
     'offset': 73,
     'context': 'llades ekstra ord ved parenteser. Anders (040480-0019 And), Andeby',
     'context_offset': 50,
     'sensitivity': None,
     'probability': 1.0},
    {'match': '0505XXXXXX',
     'offset': 109,
     'context': 'opfylder kriterium for cpr Anders And 113 050580-0001',
     'context_offset': 50,
     'sensitivity': None,
     'probability': 1.0},
    {'match': '0606XXXXXX',
     'offset': 94,
     'context': 'ord opfylder kriterium for cpr Anders And 060680-0002 070680-0018',
     'context_offset': 50,
     'sensitivity': None,
     'probability': 1.0},
    {'match': '0706XXXXXX',
     'offset': 106,
     'context': 'kriterium for cpr Anders And 060680-0002 070680-0018',
     'context_offset': 50,
     'sensitivity': None,
     'probability': 1.0},
    {'match': '0707XXXXXX',
     'offset': 123,
     'context': 'r "HOST/ABCD.intra.corp"], "uSNChanged": [070780-0003], '
    ...
    {'match': '0808XXXXXX',
     'offset': 128,
     'context': 'nteser være ubalanceret. 712000 0 0 WET} {080880-0004 3600 1 WEST} '
     '[090880-0001 0 0 WET]',
     'context_offset': 50,
     'sensitivity': None,
     'probability': 1.0},
    {'match': '0908XXXXXX',
     'offset': 154,
     'context': '712000 0 0 WET} {080880-0004 3600 1 WEST} [090880-0001 0 0 WET]',
     'context_offset': 50,
     'sensitivity': None,
     'probability': 1.0},
    {'match': '0909XXXXXX',
     'offset': 128,
     'context': 'unary) eller specialsymbol 16768 0 LMT} {090980-0005-} {+100980-0006} '
     '(#110980-0003)',
     'context_offset': 50,
     'sensitivity': None,
     'probability': 1.0},
    {'match': '1009XXXXXX',
     'offset': 144,
     'context': 'ecialsymbol 16768 0 LMT} {090980-0005-} {+100980-0006} (#110980-0003)',
     'context_offset': 50,
     'sensitivity': None,
     'probability': 1.0},
    {'match': '1109XXXXXX',
     'offset': 159, 'context': '16768 0 LMT} {090980-0005-} {+100980-0006} (#110980-0003)',
     'context_offset': 50,
     'sensitivity': None,
     'probability': 1.0},
    {'match': '0707XXXXXX',
     'offset': 83,
     'context': 'l er lukket inde i en parantes Anders And 070780-0003 (12345)',
     'context_offset': 50,
     'sensitivity': None,
     'probability': 1.0},
    {'match': '1010XXXXXX',
     'offset': 497,
     'context': '- Er der unær operator før eller efter, fx -101080-0001 eller 111080-0009+ - '
    ...
    {'match': '1110XXXXXX',
     'offset': 515,
     'context': 'r operator før eller efter, fx -101080-0001 eller 111080-0009+ - Er der '
    ...
    {'match': '1111XXXXXX',
     'offset': 596,
     'context': 'balanceret symboler eller parenteser omkring, fx [111180-0002. Men [121180-0018] '
     'vil være ok. - Kommer',
     'context_offset': 50,
     'sensitivity': None,
     'probability': 1.0},
    {'match': '1211XXXXXX',
     'offset': 614,
     'context': 'r eller parenteser omkring, fx [111180-0002. Men [121180-0018] vil være ok. - '
    ...
    {'match': '1212XXXXXX',
     'offset': 715,
     'context': 'al der ikke ligner et cpr før eller efter, fx 113 121280-0003 - Er ord før eller '
     'efter ikke ’alle små’-',
     'context_offset': 50,
     'sensitivity': None,
     'probability': 1.0},
    {'match': '1312XXXXXX',
     'offset': 838,
     'context': 'yndelsesbogstav’ eller ’alle caps’, fx uSNChanged 131280-0019 resulterer alle i '
     'sandsynlighed=0.',
     'context_offset': 50,
     'sensitivity': None,
     'probability': 1.0},
    {'match': '1412XXXXXX',
     'offset': 946,
     'context': '- indeholder ord før cpr, fx Anders cpr-nr [141280-0008] resulterer i '
     'sandsynlighed=1 F',
     'context_offset': 50,
     'sensitivity': None,
     'probability': 1.0}
